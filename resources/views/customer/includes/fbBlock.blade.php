						<div id="fb-root" class=" fb_reset">
							...
							<div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
								<div>
									<iframe name="f3695094f3f98bc" allowtransparency="true" allowfullscreen="true" scrolling="no" style="display: none;" src="{{env('FILE_PATH_CUSTOM')}}cus/images/ping.htm" frameborder="0">
									</iframe>
								</div>
							</div>
						</div>
